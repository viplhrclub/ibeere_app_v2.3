...
import 'package:flutterquiz/ui/widgets/audio_question_container.dart';
import 'package:flutterquiz/ui/widgets/circular_progress_container.dart';
import 'package:flutterquiz/ui/widgets/guess_the_word_question_container.dart';
        ...
        if (widget.questions.isEmpty) {
          ...
          if (widget.quizType == QuizTypes.audioQuestions) {
            return AudioQuestionContainer(
              ...
              hasSubmittedAnswerForCurrentQuestion:
                  widget.hasSubmittedAnswerForCurrentQuestion,
              questionAnimationController: widget.questionAnimationController,
              questionSlideAnimation: widget.questionSlideAnimation,
              questionScaleUpAnimation: widget.questionScaleUpAnimation,
              questionScaleDownAnimation: widget.questionScaleDownAnimation,
              questionContentAnimation: widget.questionContentAnimation,
              questionContentAnimationController: widget.questionContentAnimationController,
