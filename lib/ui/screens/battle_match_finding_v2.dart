...
class BattleMatchFindingV2 extends StatelessWidget {
  const BattleMatchFindingV2({super.key});
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Icon(Icons.search, size: 80, color: IbeereDesignTokens.primaryPurple),
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.pushNamed(context, '/battle-countdown');
              },
