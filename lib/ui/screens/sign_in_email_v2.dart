              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      GestureDetector(
                        onTap: () => Navigator.pushNamed(context, '/sign-up-email'),
                        child: RichText(
                          text: TextSpan(
    ...
    return Stack(
      children: [
        Positioned(
          top: 15,
          left: 20,
          child: _buildCircle(Color(0xFFFFD6D6), 28),
        ),
        Positioned(
          top: 45,
          left: 80,
          child: _buildCircle(Color(0xFFFFF4CC), 18, outlined: true),
        ),
        Positioned(
          top: 20,
          left: 160,
          child: _buildCircle(Color(0xFFD1FAE5), 14, outlined: true),
        ),
        Positioned(
          top: 15,
          right: 80,
          child: _buildDiamond(Color(0xFF94A3B8), 14),
        ),
        Positioned(
          top: 12,
          right: 20,
          child: _buildCircle(Color(0xFFD1FAE5), 20),
        ),
        Positioned(
          top: 80,
          right: 25,
          child: _buildDiamond(Color(0xFF94A3B8), 18),
        ),
        Positioned(
          top: 100,
          right: 100,
          child: _buildCircle(Color(0xFFFFF4CC), 22),
        ),
        Positioned(
          top: 15,
          left: 10,
          child: _buildCircle(Color(0xFFD1FAE5), 16),
        ),
        Positioned(
          top: -40,
          left: -60,
          child: _buildBlob(Color(0xFFFFE5E5), 180, 160),
        ),
        Positioned(
          top: 150,
          right: -70,
          child: _buildBlob(Color(0xFFDEF7EC), 160, 200),
        ),
        Positioned(
          bottom: 300,
          left: -30,
          child: _buildBlob(Color(0xFFFFF8DC), 120, 140),
        ),
        Positioned(
          bottom: 100,
          left: 30,
          child: _buildCircle(Color(0xFFFFF4CC), 16),
        ),
        Positioned(
          bottom: 200,
          left: 80,
        ...
        Positioned(
          bottom: 140,
          left: 100,
          child: _buildCircle(Color(0xFFD1FAE5), 18),
        ),
        Positioned(
          bottom: 280,
          right: 60,
          child: _buildCircle(Color(0xFFD1D5DB), 14, outlined: true),
        ),
        Positioned(
          bottom: 190,
          right: 100,
          child: _buildTriangle(Color(0xFF7DD3FC), 16),
        ),
        Positioned(
          bottom: 120,
          right: 30,
          child: _buildCircle(Color(0xFFFED7AA), 20),
        ),
        Positioned(
          bottom: 240,
          right: 40,
          child: _buildCircle(Color(0xFFFFD6D6), 24, outlined: true),
        ),
        Positioned(
          bottom: -60,
          right: -70,
          child: _buildBlob(Color(0xFFDEF7EC), 180, 190),
        ),
        Positioned(
          bottom: -50,
          left: -60,
          child: _buildBlob(Color(0xFFFFE5E5), 170, 150),
        ),
      ],
    );
  }
