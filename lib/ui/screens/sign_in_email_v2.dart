...
class _EmailSignInState extends State<EmailSignIn>
  ...
  Widget _buildFloatingDecorations() {
    final decos = [
      ...
      {'pos': Offset(50, 700), 'color': Color(0xFFFFEFD4), 'shape': 'blob'},
      {'pos': Offset(620, 850), 'color': Color(0xFFE8EAF6), 'shape': 'blob'},
      {'pos': Offset(40, 1050), 'color': Color(0xFF94A3B8), 'shape': 'circle'},
      {'pos': Offset(160, 1010), 'color': Color(0xFF94A3B8), 'shape': 'diamond'},
      {'pos': Offset(100, 1060), 'color': Color(0xFFFBBF24), 'shape': 'circle'},
      {'pos': Offset(460, 1030), 'color': Color(0xFF06B6D4), 'shape': 'triangle'},
    ...
    return Positioned(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Stack(
            children: [
              Positioned(top: 15, left: 20, child: _buildStarDeco()),
              Positioned(top: 35, left: 10, child: _buildStarDeco()),
              Positioned(top: 50, left: 25, child: _buildStarDeco()),
              Positioned(top: 25, left: 50, child: _buildStarDeco()),
              Positioned(top: 45, left: 55, child: _buildStarDeco()),
              Positioned(top: 10, left: 55, child: _buildStarDeco()),
              const Center(
                child: Icon(
                  Icons.arrow_forward,
                  color: Colors.white,
