...
class QuizPlayingScreenV2 extends StatelessWidget {
  const QuizPlayingScreenV2({super.key});
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Icon(Icons.quiz, size: 80, color: IbeereDesignTokens.primaryPurple),
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.pushNamed(context, '/quiz-victory');
              },
