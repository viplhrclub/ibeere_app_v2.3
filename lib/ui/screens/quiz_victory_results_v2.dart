...
class QuizVictoryResultsV2 extends StatelessWidget {
  const QuizVictoryResultsV2({super.key});
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Icon(Icons.emoji_events, size: 80, color: IbeereDesignTokens.primaryPurple),
