...
class QuizVictory extends StatefulWidget {
  const QuizVictory({super.key});

  @override
  State<QuizVictory> createState() => _QuizVictoryState();
}

class _QuizVictoryState extends State<QuizVictory>
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            shape: BoxShape.circle,
            border: Border.all(color: const Color(0xFF3A4A62), width: 3),
          ),
          child: ClipOval(
            child: Container(
              color: const Color(0xFF2A3A5F),
  ...
  Widget _buildLegend() {
    return Row(
      ...
      children: [
        ...
        const SizedBox(width: 40),
        _buildLegendItem(const Color(0xFFFBBF24), 'Coins'),
      ],
    );
  }
...
class StatsCirclePainter extends CustomPainter {
  @override
