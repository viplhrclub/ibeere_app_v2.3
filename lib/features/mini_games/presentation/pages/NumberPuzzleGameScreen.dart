...
class NumberPuzzleGameScreen extends StatefulWidget {
  const NumberPuzzleGameScreen({Key? key}) : super(key: key);
  @override
  State<NumberPuzzleGameScreen> createState() => _NumberPuzzleGameScreenState();
}

class _NumberPuzzleGameScreenState extends State<NumberPuzzleGameScreen> with SingleTickerProviderStateMixin {
