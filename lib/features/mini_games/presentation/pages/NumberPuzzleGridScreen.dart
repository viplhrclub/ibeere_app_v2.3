...
class NumberPuzzleGridScreen extends StatefulWidget {
  const NumberPuzzleGridScreen({Key? key}) : super(key: key);
  @override
  State<NumberPuzzleGridScreen> createState() => _NumberPuzzleGridScreenState();
}

class _NumberPuzzleGridScreenState extends State<NumberPuzzleGridScreen> with SingleTickerProviderStateMixin {
