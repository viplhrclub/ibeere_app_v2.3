...
class ScratchCardRewardScreen extends StatefulWidget {
  const ScratchCardRewardScreen({Key? key}) : super(key: key);
  @override
  State<ScratchCardRewardScreen> createState() => _ScratchCardRewardScreenState();
}

class _ScratchCardRewardScreenState extends State<ScratchCardRewardScreen> with SingleTickerProviderStateMixin {
