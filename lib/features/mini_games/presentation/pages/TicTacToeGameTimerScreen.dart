...
class TicTacToeGameTimerScreen extends StatefulWidget {
  const TicTacToeGameTimerScreen({Key? key}) : super(key: key);
  @override
  State<TicTacToeGameTimerScreen> createState() => _TicTacToeGameTimerScreenState();
}

class _TicTacToeGameTimerScreenState extends State<TicTacToeGameTimerScreen> with SingleTickerProviderStateMixin {
