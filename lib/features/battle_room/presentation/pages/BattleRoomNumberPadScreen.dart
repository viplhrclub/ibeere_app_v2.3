...
class BattleRoomNumberPadScreen extends StatefulWidget {
  const BattleRoomNumberPadScreen({Key? key}) : super(key: key);
  @override
  State<BattleRoomNumberPadScreen> createState() => _BattleRoomNumberPadScreenState();
}

class _BattleRoomNumberPadScreenState extends State<BattleRoomNumberPadScreen> with SingleTickerProviderStateMixin {
      ...
      body: FadeTransition(
        ...
        child: Form(
          ...
          child: ListView(padding: const EdgeInsets.all(24), children: [
            const Text('45_BattleRoomNumberPad_CodeEntry', style: TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.bold)),
