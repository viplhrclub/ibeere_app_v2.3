...
class BattleRoomJoinScreen extends StatefulWidget {
  const BattleRoomJoinScreen({Key? key}) : super(key: key);
  @override
  State<BattleRoomJoinScreen> createState() => _BattleRoomJoinScreenState();
}

class _BattleRoomJoinScreenState extends State<BattleRoomJoinScreen> with SingleTickerProviderStateMixin {
      ...
      body: FadeTransition(
        ...
        child: Form(
          ...
          child: ListView(padding: const EdgeInsets.all(24), children: [
            const Text('41_BattleRoomJoin_CreatePin', style: TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.bold)),
