...
class BattleRoomCreationScreen extends StatefulWidget {
  const BattleRoomCreationScreen({Key? key}) : super(key: key);
  @override
      ...
      body: FadeTransition(
        ...
        child: Form(
          ...
          child: ListView(padding: const EdgeInsets.all(24), children: [
            const Text('46_BattleRoomCreation_EntryFees', style: TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.bold)),
