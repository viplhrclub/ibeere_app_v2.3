...
class CoinHistoryVariantScreen extends StatefulWidget {
  const CoinHistoryVariantScreen({Key? key}) : super(key: key);
  @override
  State<CoinHistoryVariantScreen> createState() => _CoinHistoryVariantScreenState();
}

class _CoinHistoryVariantScreenState extends State<CoinHistoryVariantScreen> with SingleTickerProviderStateMixin {
