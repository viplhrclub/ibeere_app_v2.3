import '../../cubits/badges_cubit.dart';
...
class BadgesCollectionScreen extends StatefulWidget {
  const BadgesCollectionScreen({Key? key}) : super(key: key);
  @override
  State<BadgesCollectionScreen> createState() => _BadgesCollectionScreenState();
}

class _BadgesCollectionScreenState extends State<BadgesCollectionScreen> with SingleTickerProviderStateMixin {
