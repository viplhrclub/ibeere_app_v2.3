...
class ProfileNameInputScreen extends StatefulWidget {
  const ProfileNameInputScreen({Key? key}) : super(key: key);
  @override
  State<ProfileNameInputScreen> createState() => _ProfileNameInputScreenState();
}

class _ProfileNameInputScreenState extends State<ProfileNameInputScreen> with SingleTickerProviderStateMixin {
      ...
      body: FadeTransition(
        ...
        child: Form(
          ...
          child: ListView(padding: const EdgeInsets.all(24), children: [
            const Text('05_ProfileNameInput_Setup', style: TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.bold)),
